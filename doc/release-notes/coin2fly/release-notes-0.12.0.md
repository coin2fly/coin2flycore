...
Coin2Fly Core version 0.12.0 is now available from:

  https://coin2fly.com/downloads

Please report bugs using the issue tracker at github:

  https://github.com/coin2fly/coin2flycore/issues
...
backwards-compatible with pre-0.12 versions of Coin2Fly Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/coin2fly/).
