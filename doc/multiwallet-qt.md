...
Only requiring some minor changes is coin2fly.cpp.
...
Changes to coin2fly.cpp
----------------------
coin2fly.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
