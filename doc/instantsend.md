...
This mechanism has been integrated into Bitcore-Node-Coin2Fly which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/coin2fly/insight-api-coin2fly#web-socket-api](https://github.com/coin2fly/insight-api-coin2fly#web-socket-api)
* API: [https://github.com/coin2fly/insight-api-coin2fly#instantsend-transactions](https://github.com/coin2fly/insight-api-coin2fly#instantsend-transactions)
...
By default, the Coin2Fly Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Coin2Fly Core daemon:
