...
2. run coin2flyd with -printalert or -sendalert like this:
   /path/to/coin2flyd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.coin2fly.com";
