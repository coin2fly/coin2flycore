...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "seed1.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "seed2.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "seed3.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "seed4.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "seed5.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "seed6.coin2fly.com"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
                ...
                (11220, uint256S("0x0000000001f37a2013b744e8164ab0b963613e04cb1eaa95ec0fea938518ab7b"))
                (17230, uint256S("0x00000000018ca29346c4575713be5e3abcba76ba720b8d13f5efe956cebf9151"))
                (21100, uint256S("0x0000000001acd09f317e39bb96092340823516a2fc8f26ac15be17d064596065")),
                1520820704, // * UNIX timestamp of last checkpoint block
                116987,     // * total number of transactions between genesis and last checkpoint
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "test-seed1.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "test-seed2.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "test-seed3.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "test-seed4.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "test-seed5.coin2fly.com"));
        vSeeds.push_back(CDNSSeedData("coin2fly.com", "test-seed6.coin2fly.com"));
