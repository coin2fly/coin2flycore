...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Coin2Fly Core coin2fly-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  coin2fly-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coin2fly transaction") + "\n" +
              "  coin2fly-tx [options] -create [commands]   " + _("Create hex-encoded coin2fly transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded coin2fly transaction
