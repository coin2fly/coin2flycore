    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Coin2Fly Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Coin2Fly Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  coin2fly-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Coin2Fly in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CTF, 0.1 CTF, 1 CTF and 10 CTF -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.coin2fly.com\">www.coin2fly.com</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Coin2Fly Core is shutting down...") + "<br /><br />" +
