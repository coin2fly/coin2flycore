...
{
    if(fLiteMode) return; // ignore all Coin2Fly related functionality
...
/*
    ...
    allow endless transaction that would bloat Coin2Fly and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("coin2fly-privatesend");
